...
- (void)initViews
{
    ...
    shapeLayer.strokeColor = [UIColor colorWithRed:254/255.0 green:39/255.0 blue:112/255.0 alpha:1].CGColor;//线条颜色
...
- (void)startGouAnimation
{
    if (shapeLayerGou) {
        ...
        shapeLayerGou.strokeColor = [UIColor colorWithRed:254/255.0 green:39/255.0 blue:112/255.0 alpha:1].CGColor;//线条颜色
        shapeLayerGou.fillColor = [UIColor clearColor].CGColor;//填充颜色
        shapeLayerGou.lineWidth = 3.0;
